...
var _ = require('lodash'),
    index = exports.Tone,
    Tones = ['C_NATURAL', 'C_SHARP', 'D_NATURAL', 'D_SHARP', 'E_NATURAL', 'F_NATURAL', 'F_SHARP', 'G_NATURAL', 'G_SHARP', 'A_NATURAL', 'A_SHARP', 'B_NATURAL'];
...
function changeByHalfSteps(tone, steps) {
    ...
    if (steps > 0) {
        ...
        return Tones[index + steps] < 0 ? Tones[index + steps + numTones] : Tones[index + steps];
    } else {
        return Tones[index];
    }
}
